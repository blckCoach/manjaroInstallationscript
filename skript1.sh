...
basestrap /mnt base base-devel linux vim dhcpcd wpa_supplicant netctl dialog grub efibootmgr dosfstools gptfdisk bash-completion git mkinitcpio vpnc xorg xorg-xinit ttf-font-awesome firefox-i18n-de ranger 
